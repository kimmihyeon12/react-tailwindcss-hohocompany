...
function Recruitment(){
    ...
    return(
        ...
        <div className="mt-[2vw] overflow-y-hidden  w-[60vw] h-[38vw] bg-[white] p-[5.6vw] border-2 overflow-y-scroll custom-scroll">
        <img className="ml-[90%] h-[1vw]"src={hand} alt="" onClick={()=>{setRecruitmentPageView(!recruitmentPageView)}}/>
            <div className="">
            ...
            <div className="mt-[2vw]">
                ...
                <ul>
                    <li> <input className="pt-[1.5vw] pb-[0.5vw] w-[100%]   border-b-[1px] focus:outline-none   placeholder-black font-neob text-[1.2vw]" type="text" id="" name="" placeholder="회사명"/></li>
                    <li> <input className="pt-[1.2vw] pb-[0.5vw] w-[100%]   border-b-[1px] focus:outline-none placeholder-black font-neob text-[1.2vw]" type="text" id="" name="" placeholder="성함 / 직책"/></li>
