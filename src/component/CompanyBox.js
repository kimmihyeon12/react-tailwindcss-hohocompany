...
function CompanyBox({img,index}){
    ...
    return(
    <li className="ml-[2.3vw] mr-[2.3vw] group " onClick={(e)=>
        {   
        ...
        <div className=" relative w-[34.8vw] h-[10.4vw] overflow-hidden bg-[rgba(1,1,1,0.3)] rounded-[2vw] cursor-pointer">
            ...
            <div className="absolute flex flex-col">
                <p className="mt-[2.13vw] ml-[1.45vw] text-[1.4vw] font-neob">{img.title}</p>
                <p className=" w-[18vw] mt-[1.5vw] ml-[1.45vw] text-[1.2vw] font-neosb">{img.content}</p>
                <div className="absolute  right-[-14.5vw] top-[6.5vw] h-[3vw] bg-[#fb6b79] rounded-[2vw]  text-[1.2vw] font-neosb  pl-[1.5vw] pr-[1.5vw] pt-[0.7vw] pb-[0.7vw]">{img.text}</div>
