        ...
        <div className="">
          ...
          <Slider ref={(slider) => (this.slider = slider)} {...settings}>
            ...
            <div className="relative text-[#d9427a]">
              ...
              <p className="absolute   font-neoh text-[8vw] leading-[9.4vw] tracking-[-0.3vw] top-[205px] text-center w-full ">
                부모가 되어도
                <br />
                특별한 날은 우아하게
              </p>
              <p className="absolute   font-neoeb text-[5.2vw] tracking-[-0.1vw] top-[285px]   text-center w-full">
                지금 APP으로 만나보세요
              </p>
              <div className="absolute flex w-full justify-center top-[45vh]  ">
                <img className="w-[41vw]   mr-2" src={appstorebtn} alt="" />
